#!/bin/bash
# ==============================================================================
# MyAgent - Deployment Script for Server 192.168.9.9
# ==============================================================================
...
if [ ! -f .env ]; then
    ...
    cp .env.example .env
    echo "✅ Created .env. Please update LLM_BASE_URL if your LLM server IP is different."
else
...
echo "⏳ Waiting for backend to initialize and load embedding model..."
sleep 8

echo "=========================================================="
echo "🎉 MyAgent Successfully Deployed!"
echo "=========================================================="
echo "🌐 Web Interface:      http://192.168.9.9:3000"
